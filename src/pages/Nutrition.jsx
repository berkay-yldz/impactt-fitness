...
export default function Nutrition() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-impact-dark text-zinc-900 dark:text-white transition-colors duration-300 relative flex flex-col">
      ...
      <header className="flex items-center justify-between p-6 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-impact-surface transition-colors duration-300">
        <div className="flex items-center gap-4">
          <button onClick={() => setIsSidebarOpen(true)} className="p-2 -ml-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg transition-colors">
        ...
        <div className="flex items-center gap-4 border border-zinc-200 dark:border-zinc-800 rounded-full px-4 py-2 text-sm font-bold bg-white dark:bg-impact-dark">
